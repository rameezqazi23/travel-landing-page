...
const Footer = () => {
    return (
        <div className='w-full bg-gray-900 text-gray-300 py-8 px-2'>
            <div className='mx-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8-px-4'>
                <div>
                ...
                <div className='col-span-2 py-8 md:pt-2'>
                    ...
                    <form className='flex flex-col sm:flex-row'>
                        ...
                        <button className='p-2 mb-4 rounded-md'>Subcribe</button>
                    </form>
                </div>
            </div>

            <div className='flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500'>
                <p className='py-4'>Created with ❤️️ by Rameez Qazi</p>
